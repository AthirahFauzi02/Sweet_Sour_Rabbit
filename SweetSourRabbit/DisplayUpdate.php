...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "register")) {
  $updateSQL = sprintf("UPDATE customers SET Password=%s, Name=%s, Email=%s, Address1=%s, Address2=%s, Postcode=%s, `State`=%s, TelephoneNo=%s, Gender=%s, Usertype=%s WHERE Username=%s",
  ...
  $Result1 = mysql_query($updateSQL, $sweetsourrabbit) or die(mysql_error());
}
