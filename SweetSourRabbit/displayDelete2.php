...
if ((isset($_GET['Username'])) && ($_GET['Username'] != "")) {
  $deleteSQL = sprintf("DELETE FROM customers WHERE Username=%s",
                       GetSQLValueString($_GET['Username'], "text"));

  mysql_select_db($database_sweetsourrabbit, $sweetsourrabbit);
  $Result1 = mysql_query($deleteSQL, $sweetsourrabbit) or die(mysql_error());

  $deleteGoTo = "searchDelete.php";
