...
$query_Delete = sprintf("SELECT * FROM customers WHERE Username = %s", GetSQLValueString($colname_Delete, "text"));
$Delete = mysql_query($query_Delete, $sweetsourrabbit) or die(mysql_error());
...
<div id="wrap">
  ...
  <div class="center_content">
    <div class="left_content">
      <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" /></span>Search User to delete</div>
      <div class="feat_prod_box_details">
        <div class="contact_form">
          <form ACTION="displayDelete.php" METHOD="get" name="register" href="#">
            <div class="form_row">
