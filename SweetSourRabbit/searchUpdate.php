...
<head>
<title>Search User to Update</title>
...
<div id="wrap">
  ...
  <div class="center_content">
    <div class="left_content">
      <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" /></span>Search User to Update</div>
      <div class="feat_prod_box_details">
        <div class="contact_form">
          <form ACTION="DisplayUpdate.php" METHOD="get" name="register" href="#">
            <div class="form_row">
